...
//[Api(6)]
public sealed class MNK_DefaultPvP2 : MonkRotation
{
    public static IBaseAction MeteodrivePvP = new BaseAction((ActionID)29485);
    ...
    public int LBValue { get; set; } = 24000;
    ...
    protected override bool AttackAbility(IAction nextGCD, out IAction? action)
    {
        ...
        if (InCombat && UseThunderclap && ThunderclapPvP.Cooldown.CurrentCharges > ThunderclapValue &&  
    ...
    protected override bool GeneralGCD(out IAction? action)
    {
        ...
        if (!Player.HasStatus(true,StatusID.SnakesBane) && UseLB && MyLimitBreakLevel == 1 && Target.CurrentHp <= LBValue && MeteodrivePvP.CanUse(out action, skipAoeCheck: true, usedUp: true)) return true;
