...
[Rotation("Lelia Default PVP2", CombatType.PvP, GameVersion = "7.3", 
    Description = "WtathCombo同時使用の場合は、Dual Button Modeにして下さい。\n止まってるとファイア、動くとブリザード。\n動きまくってひゃっは～")]
[SourceCode(Path = "main/RebornRotations/PVPRotations/Magical/BLM_Default.PVP.cs")]
//[Api(6)]
public class BLM_DefaultPVP3 : BlackMageRotation
{
    ...
    protected override bool GeneralGCD(out IAction? action)
    {
        ...
        if (/*Player.HasStatus(true,StatusID.AstralFire) &&*/ !IsMoving && Player.CurrentHp >= 40000/* UseFirePvP*/)
        {
        ...
        //if (/*!Player.HasStatus(true, StatusID.AstralFire) &&*/ Player.CurrentHp < 40000/*!UseFirePvP*/)
        {
            if (FrostStarPvP.CanUse(out action))
            {
                return true;
