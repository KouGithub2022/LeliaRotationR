...
[Api(4)]
public sealed class SAM_DefaultCustom : SamuraiRotation
{
    public static IBaseAction MyKaeshiGokenPvE = new BaseAction((ActionID)16485);
    public static IBaseAction MyTendoKaeshiGokenPvE = new BaseAction((ActionID)36967);
    //public static IBaseAction MyTenkaGokenPvE = new BaseAction((ActionID)7488);
    //public static IBaseAction MyTendoGokenPvE = new BaseAction((ActionID)36965);
    ...
    protected override bool GeneralGCD(out IAction? act)
    {
        ...
        //if (MyTendoGokenPvE.CanUse(out act)) return true;
        if (TendoGokenPvE.CanUse(out act)) return true;
        //if (MyTenkaGokenPvE.CanUse(out act)) return true;
        ...
        //UpDate
        if (Player.HasStatus(true,StatusID.TsubamegaeshiReady) && MyKaeshiGokenPvE.CanUse(out act, usedUp: true, skipAoeCheck: true)) return true;
        if (Player.HasStatus(true, StatusID.TsubamegaeshiReady) && MyTendoKaeshiGokenPvE.CanUse(out act, usedUp: true, skipAoeCheck:true)) return true;
        //UpDateEnd
