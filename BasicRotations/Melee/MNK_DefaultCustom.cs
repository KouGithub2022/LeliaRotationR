...
[Rotation("Default_Custom", CombatType.PvE, GameVersion = "7.00", Description = "Uses Lunar Solar Opener from The Balance")]
[SourceCode(Path = "main/DefaultRotations/Melee/MNK_Default.cs")]
[Api(4)]

public sealed class MNK_DefaultCustom : MonkRotation
{
    ...
    protected override bool EmergencyAbility(IAction nextGCD, out IAction? act)
    {
        ...
        // 'The form shift and meditation prepull are implied. Prepull pot should win out, but choosing to press it in the first few weave slots shouldn$00A1$00AFt result in more than a single digit loss'
        ...
        if (/*Player.HasStatus(true, StatusID.EarthsRumination) &&*/ EarthsReplyPvE.CanUse(out act)) return true;
    ...
    protected override bool GeneralGCD(out IAction? act)
    {
        ...
        // 'Because Fire$00A1$00AFs Reply grants formless, we have an imposed restriction that we prefer not to use it while under PB, or if we have a formless already.' + 'Cast Fire's Reply after an opo gcd'
        ...
        // 'This means $00A1°bookending$00A1± any PB usage with opos and spending formless on opos.'
